        ...
        call.enqueue(new Callback<Token>() {
            ...
            public void onResponse(Call<Token> call, Response<Token> response) {
                ...
                if (token != null) {
                    ...
                    startActivity(intent);
                    CustomToast.makeText(LoginActivity.this,"Login Success",CustomToast.LENGTH_LONG,CustomToast.SUCCESS,false).show();
                } else {
                    dialog.dismiss();
                    CustomToast.makeText(LoginActivity.this,"Login Fail",CustomToast.LENGTH_LONG,CustomToast.WARNING,false).show();
                }
            }
